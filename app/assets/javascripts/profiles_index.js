...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProfileIndexBox = (function (_React$Component) {
	    _inherits(ProfileIndexBox, _React$Component);

	    function ProfileIndexBox(props) {
	        _classCallCheck(this, ProfileIndexBox);

	        _get(Object.getPrototypeOf(ProfileIndexBox.prototype), 'constructor', this).call(this, props);
	        this.state = {
	            profiles: []
	        };
	    }

	    _createClass(ProfileIndexBox, [{
	        ...
	        key: 'handleFollowingListRequest',
	        value: function handleFollowingListRequest() {
	            $.ajax({
	                url: url,
	                dataType: 'json',
	        ...
	        value: function render() {
	            return React.createElement(
	                'div',
	                { className: 'profileIndexBox' },
	                React.createElement(Subnav, { handleFollowingListRequest: this.handleFollowingListRequest.bind(this),
	                ...
	                React.createElement(ProfilesMasonry, { profiles: this.state.profiles })
	            );
	        }
	    }]);

	    return ProfileIndexBox;
	})(React.Component);
	...
	var Subnav = (function (_React$Component2) {
	    ...
	    function Subnav() {
	        ...
	        _get(Object.getPrototypeOf(Subnav.prototype), 'constructor', this).apply(this, arguments);
	    }
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            'li',
	                            { role: 'presentation', onClick: this.handleAllListRequest.bind(this) },
	                            React.createElement(
	                                'a',
	                                { href: '#' },
	                                lang.allUsers
	                        ...
	                        React.createElement(
	                            'li',
	                            { role: 'presentation', onClick: this.handleFollowingListRequest.bind(this) },
	                            React.createElement(
	                                'a',
	                                { href: '#' },
	                                lang.followings
	                        ...
	                        React.createElement(
	                            'li',
	                            { role: 'presentation', onClick: this.handleFollowersListRequest.bind(this) },
	                            React.createElement(
	                                'a',
	                                { href: '#' },
	                                lang.followers
	...
	var ProfilesMasonry = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                'div',
	                { ref: 'masonryContainer', id: 'masonry-container', className: 'centered container clearfix' },
	                list
	            )
	        );
	    }
	...
	var ProfileMasonryBox = (function (_React$Component3) {
	    _inherits(ProfileMasonryBox, _React$Component3);

	    function ProfileMasonryBox() {
	        _classCallCheck(this, ProfileMasonryBox);

	        _get(Object.getPrototypeOf(ProfileMasonryBox.prototype), 'constructor', this).apply(this, arguments);
	    }
	        ...
	        value: function render() {
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'ul',
	                        { className: 'image-section-wrapper' },
	                        React.createElement(
	                            'li',
	                            null,
	                            React.createElement('img', { src: this.props.userimage, className: 'profile-image' })
	                        ),
	                        React.createElement(
	                            'div',
	                            ...
	                            React.createElement(
	                                'div',
	                                { className: 'left-float-btn-group clearfix' },
	                                React.createElement(
	                                    'a',
	                                    { href: this.props.url },
	                                    React.createElement(
	                            ...
	                            React.createElement(
	                                'div',
	                                { className: 'bottom-float-btn-group' },
	                                React.createElement(
	                                    'a',
	                                    { href: this.props.url },
	                                    React.createElement(
	                    ...
	                    React.createElement(
	                        'div',
	                        { className: 'profile-box-info-bottom' },
	                        React.createElement(
	                            'p',
	                            null,
	                            this.props.point,
	    ...
	    return ProfileMasonryBox;
	})(React.Component);

	React.render(React.createElement(ProfileIndexBox, null), document.getElementById('content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Masonry = isBrowser ? window.Masonry || __webpack_require__(2) : null;
	var imagesloaded = isBrowser ? __webpack_require__(15) : null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if ( true ) {
	  // CommonJS for Component
	  module.exports = defineGetSize( __webpack_require__(14) );
	} else if ( typeof define === 'function' && define.amd ) {
	  // AMD for RequireJS
	  define( [ 'get-style-property/get-style-property' ], defineGetSize );
	} else {
